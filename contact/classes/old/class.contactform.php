<?php
session_start();
include_once $_SERVER['DOCUMENT_ROOT'] . "/" . "includes/drug-master/session.php";
...
class contactForm{
	...
	public function sendEmailToAdmin($subject="Technical Info for Admin"){
		...
		$mySendEmail->sendEmail("luis@opiates.com", $subject, $TxtBody2); 
	}
	public function sendEmailToSales(){
		$CustEmail = "luis@opiates.com";
		$mySendEmail = new sendEmail();
		$TxtBody2 = "-------------------------------------------"."\n\n";
		$TxtBody2 .= "Referer: " . "\n" . $this->webPageReferer . "\n" . $this->thisPageReferer;
	...
	public function sendEmailToVisitor(){
		$emailContent = 'The Waismann Method
		----------------------------------------------------------------------
		Dear Subscriber,'."\n\n";
		/*if(emailupdates=='Yes, you may send updates'){ 
			$emailContent.="
		
		Thank you for signing up for a Opiates.com newsletter and updates.";
		}*/
		$emailContent .= '

		Thank you, we have received your email. 
		To ensure that you receive our emails, please add info@opiates.com to your contact list. 
		...
		http://www.opiates.com/legal/
		
		PRIVACY
		We will never share your e-mail address without your explicit permission. 
		Please read our Privacy Policy.
		http://www.opiates.com/legal/privacy-policy.html
		
		Sincerely,
		Opiates.com';
		$mySendEmail = new sendEmail();
		$fromEmail ='From: Waismann Method <info@opiates.com>';
		$subjectEmail ="Opiates.com: Confirming Your E-Mail Address"; 
