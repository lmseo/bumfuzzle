<?php
	...
	$filter->add_dir("calenoscom");
	$filter->add_dir("edrugsco");
	$filter->add_dir("epainco");
	$filter->add_dir("homeviolencenet");
	$filter->add_dir("instant-bailcom");
	$filter->add_dir("liquidoco");
	$filter->add_dir("liquidosco");
	$filter->add_dir("vallunoscomco");
	$filter->add_dir("treatmentsearchco");
	$filter->add_dir("errordocuments");
	$filter->add_dir("about");
	$filter->add_dir("causas");
	$filter->add_dir("ebenzos");
	$filter->add_dir("eopiluis");
	$filter->add_dir("hcc-thumbs");
	$filter->add_dir("legal");
	$filter->add_dir("assets");
	$filter->add_dir("respond-proxy");
	$filter->add_dir("blog");
	$filter->add_dir("forum");
	$filter->add_dir("sitemap");
	$filter->add_dir("countries");
	$filter->add_dir("misspellings");
	$filter->add_dir("ativan");
	$filter->add_dir("codeineaddiction");
	$filter->add_dir("oxycodoneaddiction");
	...
	$filter->add_dir(".errordocs");
	$filter->add_dir("stats");	
	$filter->add_dir(".hcc.thumbs");
	$filter->add_dir("luismosqueraco");
	$filter->add_dir("myaddictionco");
	$filter->add_dir("opioidescom");
	$filter->add_dir("opiateslistcom");
	$filter->add_dir("sk1nco");
	$filter->add_dir("speedybailnet");
	$filter->add_dir("vallunoscom");
	$filter->add_dir("edrugsco");
	$filter->add_dir("replaced-articles");
	//$filter->add_file("favicon.ico");
	$filter->add_file("hcc-thumbs.html");
	$filter->add_file("channel.html");
	...
	$filter->add_file("google7bdeab9b422fbd09.html");	
?>