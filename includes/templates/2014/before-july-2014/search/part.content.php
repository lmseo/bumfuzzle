<div id="fb-root"></div><script>window.fbAsyncInit=function(){FB.init({appId:'273946516037384',channelUrl:'//www.eopiates.com/channel.html', status: true, cookie:true, xfbml:true });};(function(d){var js, id = 'facebook-jssdk', ref = d.getElementsByTagName('script')[0];if (d.getElementById(id)) {return;}js = d.createElement('script'); js.id = id; js.async = true;js.src = "//connect.facebook.net/en_US/all.js";ref.parentNode.insertBefore(js, ref);}(document));</script><div class="pushwrapper"><?php include_once( $include_root . '/includes/templates/2014/main/part.topToolBar.php'); ?><?php include_once($include_root . '/includes/templates/2014/main/part.header.php'); ?><div class="divider"></div><div id="main" role="main"><div class="wrapper"><!-- google_ad_section_start --><div class="breadcrumbs" style=""><?php $newPage->printBreadCrumb(); ?></div><section class='left-section'><?php $newPage->printH1();?><?php //endif; $newPage->printH2(); ?><?php //$newPage->printContent(); ?><div><script>
  (function() {
    var cx = '010623917619497383398:eqlvgcbrg70';
...
</div><!-- google_ad_section_end --></section><section class="last"><!-- google_ad_section_start(weight=ignore) --><?php include_once($include_root . '/includes/templates/2014/main/part.contact.php'); ?><!-- google_ad_section_end --><!-- google_ad_section_start(weight=ignore) --><?php $newPage->printAdditionalFilesinFolderLinks(); $newPage->printRightNavBarLinks();?><!-- google_ad_section_end --></section></div></div><div class="combination-information"><div class="wrapper"></div></div></div><div class="push"></div></div><div class="dividerBottom"></div><!-- google_ad_section_start(weight=ignore) --><?php include_once($include_root . '/includes/templates/2014/main/part.footer.php'); ?><!-- google_ad_section_end --><script src="/assets/javascript/2014/plugins/response.min.js" type="text/javascript"></script><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.min.js"></script><script>window.jQuery || document.write('<script src="http://cfb53adb9351fd691fd4-80f3ec783953bb03d20a214936320935.r9.cf1.rackcdn.com/javascript/jquery/jquery.min.js"><\/script>')</script><script src="http://cfb53adb9351fd691fd4-80f3ec783953bb03d20a214936320935.r9.cf1.rackcdn.com/javascript/script-v2.js"></script><script>// iOS fixes
