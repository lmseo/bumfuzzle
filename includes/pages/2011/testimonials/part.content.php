...
<?php //$newPage->printH1();
	//$newPage->printH2(); 
	//include_once($include_root  . "/includes/testimonials/main-content.php"); 
	$newPage->printContent();		
	//$newPage->printDateModified(); ?>
...
<div id="column-right"><div class="waismann-facts">
<p><img src="/images/fact.gif" alt="A Waismann Fact" width="130" height="15" /> </p>
<p>
...
<script language="JavaScript" src="/swap/fact.js"></script>
</p>
</div><?php $newPage->printRightNavBarLinks(); ?></div>
<!--End of Column-right-->
</div>
<!--End Wrapper Bottom-->    		
</div>
